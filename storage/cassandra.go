...
func (c *CassandraAdapter) GetSchemaName() string {
	return c.clusterConfig.Keyspace
}
...
func (c *CassandraAdapter) Get(dest any, filters map[string]any) error {
...
func (c *CassandraAdapter) Update(item any, filters map[string]any) error {
	s, sessionErr := c.createSession()
	if sessionErr != nil {
...
func (c *CassandraAdapter) Delete(item any, filters map[string]any) error {
	s, sessionErr := c.createSession()
	if sessionErr != nil {
...
func (c *CassandraAdapter) List(dest any, sortKey string, filters map[string]any, limit int, cursor string) (string, error) {
	s, sessionErr := c.createSession()
	if sessionErr != nil {
