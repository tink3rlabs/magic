...
- **[Quick start](https://tink3rlabs.github.io/magic/main/getting-started/index.md)** — install, run a script, see Lucene search work in under a minute.
- **[Tutorial](https://tink3rlabs.github.io/magic/main/tutorial/index.md)** — build a real microservice in 15 minutes: handlers, auth, health, observability.
