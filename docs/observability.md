...
**Advanced:** the design rationale, package layout, and full instrumentation surface live in [observability-internals.md](observability-internals.md).
